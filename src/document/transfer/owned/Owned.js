import { Divider, Grid, Hidden, IconButton, InputBase, ListItem, ListItemIcon, ListItemText, Paper, Tooltip, Typography } from '@material-ui/core';
...
const Owned = (props) => {
  ...
  const onViewClick = (id) => {
    history.push(`/transfer/documents/${id}`);
  };
          ...
          <Grid container>
            ...
            <Grid item xs>
              <Typography
                ...
                color="textSecondary"
              >
                {`${documents[index].status} - ${documents[index].certDate}`}
              </Typography>
            </Grid>
          </Grid>
        )}
  ...
  return (
    <Paper className={rootClasses.tab}>
      {/* FOLDER TREE */}
      <Grid container>
        <Grid item xs={12} md={3} style={{ minWidth: 220 }}>
        ...
        <Grid item xs={12} md>
          <Grid container direction="row">
            ...
            <Grid container item xs justify="flex-end">
              ...
              <Tooltip title={t('common:add_document')}>
                <IconButton
